...
BOOST_AUTO_TEST_CASE(zerocoin_spend_test)
{
    ...
    cWallet.zxlnTracker = unique_ptr<CzXLNTracker>(new CzXLNTracker(cWallet.strWalletFile));
    ...
    BOOST_CHECK_MESSAGE(receipt.GetStatus() == ZXLN_TRX_FUNDS_PROBLEMS, "Failed Invalid Amount Check");
