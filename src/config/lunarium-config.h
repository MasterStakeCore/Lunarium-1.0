/* src/config/lunarium-config.h.  Generated from lunarium-config.h.in by configure.  */
/* src/config/lunarium-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.lunarium.com"
