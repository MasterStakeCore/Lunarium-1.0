...
/* Lunarium GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Lunarium"
#define QAPP_ORG_DOMAIN "lunarium.foundation"
#define QAPP_APP_NAME_DEFAULT "Lunarium"
#define QAPP_APP_NAME_TESTNET "Lunarium-Qt-testnet"
