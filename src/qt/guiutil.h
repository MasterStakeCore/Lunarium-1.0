...
/** Utility functions used by the Lunarium Qt UI.
 */
namespace GUIUtil
{
...
// Render Lunarium addresses in monospace font
...
// Parse "lunarium:" URI into recipient object, return true on successful parsing
