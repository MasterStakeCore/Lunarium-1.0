...
// Copyright (c) 2015-2018 The Lunarium developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXLNPathCustom = GetArg("-zxlnbackuppath", "");
    ...
    if(!strzXLNPathCustom.empty()) {
        ui->wallet_customzxlnbackuppath->setText(QString::fromStdString(strzXLNPathCustom));
        ui->wallet_customzxlnbackuppath_label->setVisible(true);
        ui->wallet_customzxlnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXLNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Lunarium RPC console.") + "<br>" +
