                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lunarium") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lunarium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lunarium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Access the site and get all the information about Xln Protocol"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lunarium"), this);
    aboutAction->setStatusTip(tr("Show information about Lunarium"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lunarium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lunarium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lunarium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Lunarium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible Lunarium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lunarium client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lunarium network", "", count));
}
...
{
    QString strTitle = tr("Lunarium"); // default title
