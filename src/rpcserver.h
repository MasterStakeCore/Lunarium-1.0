...
extern UniValue setzxlnseed(const UniValue& params, bool fHelp);
extern UniValue getzxlnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxln(const UniValue& params, bool fHelp);
extern UniValue dzxlnstate(const UniValue& params, bool fHelp);
