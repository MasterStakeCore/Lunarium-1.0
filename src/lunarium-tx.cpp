...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lunarium lunarium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lunarium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lunarium transaction") + "\n" +
                               "  lunarium-tx [options] -create [commands]   " + _("Create hex-encoded lunarium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lunarium transaction
