...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Lunarium server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Lunarium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lunarium features */
        {"lunarium", "masternode", &masternode, true, true, false},
        {"lunarium", "listmasternodes", &listmasternodes, true, true, false},
        {"lunarium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lunarium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lunarium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"lunarium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"lunarium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"lunarium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lunarium", "masternodedebug", &masternodedebug, true, true, false},
        {"lunarium", "startmasternode", &startmasternode, true, true, false},
        {"lunarium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lunarium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lunarium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lunarium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lunarium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lunarium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lunarium", "mnbudget", &mnbudget, true, true, false},
        {"lunarium", "preparebudget", &preparebudget, true, true, false},
        {"lunarium", "submitbudget", &submitbudget, true, true, false},
        {"lunarium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lunarium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lunarium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lunarium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lunarium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lunarium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lunarium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lunarium", "checkbudgets", &checkbudgets, true, true, false},
        {"lunarium", "mnsync", &mnsync, true, true, false},
        {"lunarium", "spork", &spork, true, true, false},
        {"lunarium", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzxlnseed", &getzxlnseed, false, false, true},
        {"zerocoin", "setzxlnseed", &setzxlnseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxln", &searchdzxln, false, false, true},
        {"zerocoin", "dzxlnstate", &dzxlnstate, false, false, true}
...
{
    return "> lunarium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42523/\n";
}
